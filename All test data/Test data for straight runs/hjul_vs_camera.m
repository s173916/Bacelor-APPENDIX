...
Name_1 = '10.1_Fast camera_pose.csv';
Name_2 = '10.1_Fast robot_pose.csv';
...
Name_1 = '10.1_Fast camera_pose.csv';
Name_2 = '10.1_Fast robot_pose.csv';
Name_3 = '10.2_Fast camera_pose.csv';
Name_4 = '10.2_Fast robot_pose.csv';
Name_5 = '10.3_Fast camera_pose.csv';
Name_6 = '10.3_Fast robot_pose.csv';
Name_7 = '10.4_Fast camera_pose.csv';
Name_8 = '10.4_Fast robot_pose.csv';
Name_9 = '10.5_Fast camera_pose.csv';
Name_10 = '10.5_Fast robot_pose.csv';
Name_11 = '10.6_Fast camera_pose.csv';
Name_12 = '10.6_Fast robot_pose.csv';
Name_13 = '10.7_Fast camera_pose.csv';
Name_14 = '10.7_Fast robot_pose.csv';
Name_15 = '10.8_Fast camera_pose.csv';
Name_16 = '10.8_Fast robot_pose.csv';
Name_17 = '10.9_Fast camera_pose.csv';
Name_18 = '10.9_Fast robot_pose.csv';
Name_19 = '10.10_Fast camera_pose.csv';
Name_20 = '10.10_Fast robot_pose.csv';


% _____________________ indlæser filerne______________________________

camera_pos_1_Fast= readtable(Name_1, 'ReadVariableNames',true);
[N1,M1]      = size(camera_pos_1_Fast);

camera_pos_3_Fast= readtable(Name_3, 'ReadVariableNames',true);
[N3,M3]      = size(camera_pos_3_Fast);

camera_pos_5_Fast= readtable(Name_5, 'ReadVariableNames',true);
[N5,M5]      = size(camera_pos_5_Fast);

camera_pos_7_Fast= readtable(Name_7, 'ReadVariableNames',true);
[N7,M7]      = size(camera_pos_7_Fast);

camera_pos_9_Fast= readtable(Name_9, 'ReadVariableNames',true);
[N9,M9]      = size(camera_pos_9_Fast);

camera_pos_11_Fast= readtable(Name_11, 'ReadVariableNames',true);
[N11,M11]      = size(camera_pos_11_Fast);

camera_pos_13_Fast= readtable(Name_13, 'ReadVariableNames',true);
[N13,M13]      = size(camera_pos_13_Fast);

camera_pos_15_Fast= readtable(Name_15, 'ReadVariableNames',true);
[N15,M15]      = size(camera_pos_15_Fast);

camera_pos_17_Fast= readtable(Name_17, 'ReadVariableNames',true);
[N17,M17]      = size(camera_pos_17_Fast);

camera_pos_19_Fast= readtable(Name_19, 'ReadVariableNames',true);
[N19,M19]      = size(camera_pos_19_Fast);


% converts it to an array
A_1 = table2array(camera_pos_1_Fast);

% converts it to an array
A_3 = table2array(camera_pos_3_Fast);

% converts it to an array
A_5 = table2array(camera_pos_5_Fast);

% converts it to an array
A_7 = table2array(camera_pos_7_Fast);

% converts it to an array
A_9 = table2array(camera_pos_9_Fast);

% converts it to an array
A_11 = table2array(camera_pos_11_Fast);

% converts it to an array
A_13 = table2array(camera_pos_13_Fast);

% converts it to an array
A_15 = table2array(camera_pos_15_Fast);


% converts it to an array
A_17 = table2array(camera_pos_17_Fast);

% converts it to an array
A_19 = table2array(camera_pos_19_Fast);




% Fil 2
pos_robot_2_Fast= readtable(Name_2, 'ReadVariableNames',true);
[N2,M2]      = size(pos_robot_2_Fast);

pos_robot_4_Fast= readtable(Name_4, 'ReadVariableNames',true);
[N4,M4]      = size(pos_robot_4_Fast);

pos_robot_6_Fast= readtable(Name_6, 'ReadVariableNames',true);
[N6,M6]      = size(pos_robot_6_Fast);

pos_robot_8_Fast= readtable(Name_8, 'ReadVariableNames',true);
[N8,M8]      = size(pos_robot_8_Fast);

pos_robot_10_Fast= readtable(Name_10, 'ReadVariableNames',true);
[N10,M10]      = size(pos_robot_10_Fast);

pos_robot_12_Fast= readtable(Name_12, 'ReadVariableNames',true);
[N12,M12]      = size(pos_robot_12_Fast);

pos_robot_14_Fast= readtable(Name_14, 'ReadVariableNames',true);
[N14,M14]      = size(pos_robot_14_Fast);

pos_robot_16_Fast= readtable(Name_16, 'ReadVariableNames',true);
[N16,M16]      = size(pos_robot_16_Fast);

pos_robot_18_Fast= readtable(Name_18, 'ReadVariableNames',true);
[N18,M18]      = size(pos_robot_18_Fast);

pos_robot_20_Fast= readtable(Name_20, 'ReadVariableNames',true);
[N20,M20]      = size(pos_robot_20_Fast);

% converts it to an array
A_2 = table2array(pos_robot_2_Fast);

% converts it to an array
A_4 = table2array(pos_robot_4_Fast);

% converts it to an array
A_6 = table2array(pos_robot_6_Fast);

% converts it to an array
A_8 = table2array(pos_robot_8_Fast);

% converts it to an array
A_10 = table2array(pos_robot_10_Fast);

% converts it to an array
A_12 = table2array(pos_robot_12_Fast);

% converts it to an array
A_14 = table2array(pos_robot_14_Fast);

% converts it to an array
A_16 = table2array(pos_robot_16_Fast);

% converts it to an array
A_18 = table2array(pos_robot_18_Fast);

% converts it to an array
A_20 = table2array(pos_robot_20_Fast);
...
slutpos_cam_10_Fast = [A_1(end-cut,1)-x_faktisk_1, -A_1(end-cut,3)-y_faktisk_1; 
    A_3(end-cut,1)-x_faktisk_2, -A_3(end-cut,3)-y_faktisk_2;
    A_5(end-cut,1)-x_faktisk_3, -A_5(end-cut,3)-y_faktisk_3; 
    A_7(end-cut,1)-x_faktisk_4, -A_7(end-cut,3)-y_faktisk_4;
    A_9(end-cut,1)-x_faktisk_5, -A_9(end-cut,3)-y_faktisk_5; 
...
slutpos_rob_10_Fast = [A_2(end-cut,1)-x_faktisk_1, A_2(end-cut,2)-y_faktisk_rob1; 
    A_4(end-cut,1)-x_faktisk_2, A_4(end-cut,2)-y_faktisk_rob2; 
    A_6(end-cut,1)-x_faktisk_3, A_6(end-cut,2)-y_faktisk_rob3; 
    A_8(end-cut,1)-x_faktisk_4, A_8(end-cut,2)-y_faktisk_rob4;
    A_10(end-cut,1)-x_faktisk_5, A_10(end-cut,2)-y_faktisk_rob5; 
...
% ________________________________ Regner _______________________________
Gennemsnit_cam_10_Fast = mean(slutpos_cam_10_Fast)
Varians_cam_10_Fast = var(slutpos_cam_10_Fast)
Kovarians_cam_10_Fast = cov(slutpos_cam_10_Fast)
Staandard_var_cam_10_Fast = std(slutpos_cam_10_Fast)


Gennemsnit_rob_10_Fast = mean(slutpos_rob_10_Fast)
Varians_rob_10_Fast = var(slutpos_rob_10_Fast)
Kovarians_rob_10_Fast = cov(slutpos_rob_10_Fast)
Staandard_var_rob_10_Fast = std(slutpos_rob_10_Fast)

% __________________________________ Plotter Histogrammer ______________

figure
subplot(2,2,1)
hist(slutpos_cam_10_Fast(1:end-cut,1))
xlabel('x') 
ylabel('Probability')
title('Camenra x deviation')
subplot(2,2,2)
hist(slutpos_rob_10_Fast(1:end-cut,1))
xlabel('x') 
ylabel('Probability')
title('Wheel x deviation')
subplot(2,2,3)
hist(slutpos_cam_10_Fast(1:end-cut,2))
xlabel('y') 
ylabel('Probability')
title('Camenra y deviation')
subplot(2,2,4)
hist(slutpos_rob_10_Fast(1:end-cut,2))
xlabel('y') 
ylabel('Probability')
title('Wheel y deviation')
...
figure
subplot(2,1,1)
qqplot(slutpos_cam_10_Fast(1:end-cut,2))
title('QQ-plot for Camemara Pos y')
subplot(2,1,2)
qqplot(slutpos_cam_10_Fast(1:end-cut,1))
title('QQ-plot for Camemara Pos x')


figure
subplot(2,1,1)
histfit(slutpos_cam_10_Fast(1:end-cut,2),10)
title('Normal Distribution from Histogram y')
xlabel('y') 
ylabel('Probability')
subplot(2,1,2)
histfit(slutpos_cam_10_Fast(1:end-cut,1),10)
title('Normal Distribution from Histogram x')
xlabel('x') 
ylabel('Probability')
...
figure
subplot(2,1,1)
histfit(slutpos_cam_10_Fast(1:end-cut,2))
title('Normal Distribution from Histogram fittet Together y')
xlabel('y') 
ylabel('Probability')
subplot(2,1,2)
histfit(slutpos_cam_10_Fast(1:end-cut,1))
title('Normal Distribution from Histogram fittet Together x')
xlabel('x') 
ylabel('Probability')
...
Value_array = [Gennemsnit_cam_5(1), Gennemsnit_cam_5(2), Varians_cam_5(1), Varians_cam_5(2), Staandard_var_cam_5(1), Staandard_var_cam_5(2), min(slutpos_cam_5(1:end,1)), min(slutpos_cam_5(1:end,2)), max(slutpos_cam_5(1:end,1)), max(slutpos_cam_5(1:end,2));
    ...
    Gennemsnit_cam_10_Fast(1), Gennemsnit_cam_10_Fast(2), Varians_cam_10_Fast(1), Varians_cam_10_Fast(2), Staandard_var_cam_10_Fast(1), Staandard_var_cam_10_Fast(2), min(slutpos_cam_10_Fast(1:end,1)), min(slutpos_cam_10_Fast(1:end,2)), max(slutpos_cam_10_Fast(1:end,1)), max(slutpos_cam_10_Fast(1:end,2));
]
...
Value_array_rob = [Gennemsnit_rob_5(1), Gennemsnit_rob_5(2), Varians_rob_5(1), Varians_rob_5(2), Staandard_var_rob_5(1), Staandard_var_rob_5(2), min(slutpos_rob_5(1:end,1)), min(slutpos_rob_5(1:end,2)), max(slutpos_rob_5(1:end,1)), max(slutpos_rob_5(1:end,2));
    ...
    Gennemsnit_rob_10_Fast(1), Gennemsnit_rob_10_Fast(2), Varians_rob_10_Fast(1), Varians_rob_10_Fast(2), Staandard_var_rob_10_Fast(1), Staandard_var_rob_10_Fast(2), min(slutpos_rob_10_Fast(1:end,1)), min(slutpos_rob_10_Fast(1:end,2)), max(slutpos_rob_10_Fast(1:end,1)), max(slutpos_rob_10_Fast(1:end,2));
]
...
Value_array_k = [Gennemsnit_kun_cam_5(1), Gennemsnit_kun_cam_5(2), Varians_kun_cam_5(1), Varians_kun_cam_5(2), Staandard_var_kun_cam_5(1), Staandard_var_kun_cam_5(2), min(array_d5(1:end,1)), min(array_d5(1:end,2)), max(array_d5(1:end,1)), max(array_d5(1:end,2));
...
csvwrite('kun_camera_stat_minus_odo.csv',Value_array_k)
...
%% roterings resultat på 10m_Fast


fejl_1 = 0.14-0.1183;
fejl_2 = 0.19-0.006315;
fejl_3 = 0.02-0.02281;
fejl_4 = 0.07-0.06007;
fejl_5 = -0.16-(-0.09978);
fejl_6 = 0.19-0.2468;
fejl_7 = 0.175 - 0.01678;
fejl_8 = -0.11-(0.0368);
fejl_9 = -0.18-(-0.0368);
fejl_10 = -0.05-(-0.04709);


array_fejl_10_fast = [fejl_1, fejl_2, fejl_3, fejl_4, fejl_5, fejl_1, fejl_6,fejl_7,fejl_8,fejl_9,fejl_10]; 


Gennemsnit_10_fast = mean(array_fejl_10_fast)
Varians_10_fast = var(array_fejl_10_fast)
Kovarians_10_fast = cov(array_fejl_10_fast)
Staandard_var_10_fast = std(array_fejl_10_fast)
...
fejl_8y = 9.974-9.98;
fejl_9y = 9.988-9.98;
fejl_10y = 9.986-9.985;


array_fejl_10y_fast = [fejl_1y, fejl_2y, fejl_3y, fejl_4y, fejl_5y, fejl_1y, fejl_6y,fejl_7y,fejl_8y,fejl_9y,fejl_10y]; 


Gennemsnit_10y_fast = mean(array_fejl_10y_fast)
Varians_10y_fast = var(array_fejl_10y_fast)
Kovarians_10y_fast = cov(array_fejl_10y_fast)
Staandard_var_10y_fast = std(array_fejl_10y_fast)
...
% 
% 
% array_fejl_20_fast = [fejl_1, fejl_2, fejl_3, fejl_4, fejl_5, fejl_1, fejl_6,fejl_7,fejl_8,fejl_9,fejl_10]; 
% 
% 
% Gennemsnit_10_fast = mean(array_fejl_20_fast)
% Varians_10_fast = var(array_fejl_20_fast)
% Kovarians_10_fast = cov(array_fejl_20_fast)
% Staandard_var_10_fast = std(array_fejl_20_fast)
